...
void mnistFreeDataset(mnist_dataset_t * dataSets);
int mnistBatch(mnist_dataset_t * dataSets, mnist_dataset_t * batch, int batch_size, int batch_number);
